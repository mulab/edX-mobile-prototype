...
(function( $, undefined ) {
	...
	$.widget( "mobile.fixedtoolbar", $.mobile.widget, {
		options: {
			...
			fullscreen: false,
			tapToggle: true,
			tapToggleBlacklist: "a, button, input, select, textarea, .ui-header-fixed, .ui-footer-fixed, .ui-popup, .ui-panel, .ui-panel-dismiss-open, .ui-userpanel, .ui-userpanel-dismiss-open",
